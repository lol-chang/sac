...
if __name__ == "__main__":
    api_config = {
        "gpt-4o": {
            "api_key": os.getenv("OPENAI_API_KEY"),  # 환경 변수에서 API 키 읽음
            "url": "https://api.openai.com/v1/",
            "model": "gpt-4o",
        },
    }

    input_path = r"/Users/changjin/Desktop/Workspace/lab/sac/관광지_crawaling/[7]tour_places_with_reviews.jsonl"
    output_path = r"/Users/changjin/Desktop/Workspace/lab/sac/관광지_crawaling/[8]llm_gen_likes.jsonl"
