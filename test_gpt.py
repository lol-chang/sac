...
def create_smart_prompt(itinerary, candidates):
    ...
    prompt = f"""Expert travel planner: Create an optimal 3-day itinerary in Korea with unique daily places, budget control, and 3km movement limit. Please respond in JSON format.
